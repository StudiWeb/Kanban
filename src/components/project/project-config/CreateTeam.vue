<template>
    ...
    export default {
        ...
        props: ['teamName','projectManagerId','teamLeaderId','employees','teamMembers'],
        ...
        methods: {
            ...
            selectTeamMember(id) {
                ...
                if(this.selectedTeamMember.isSelectedAsProjectManager === true || this.selectedTeamMember.isSelectedAsTeamLeader === true ) {
                    this.$emit('show-info');
                    this.$refs.moveTeamMemberToEmployeesButton.disabled = true;
                } else {
