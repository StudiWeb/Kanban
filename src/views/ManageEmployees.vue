<template>
  ...
  <div class="row mt-4">
    <ul class="nav nav-pills">
      <li class="nav-item">
        <button
          @click="setPage('employee-list', 'list')"
          id="list"
          class="nav-link active-list ml-2"
        >
          List of employees
        </button>
      </li>
      <li class="nav-item">
        <button
          @click="setPage('add-employee', 'add')"
          id="add"
          class="nav-link"
          href="#"
        >
      ...
      <li class="nav-item">
        <button
          @click="setPage('edit-employee', 'edit')"
          id="edit"
          class="nav-link"
          href="#"
        >
      ...
      <li class="nav-item">
        <button
          @click="setPage('delete-employee', 'delete')"
          id="delete"
          class="nav-link"
        >
          Delete employee
  ...
  <component :is="page" :key="componentKey" @change-key="changeKey">
  </component>
</template>
